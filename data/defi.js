export default [{
  ...
  description: 'This preset of binder creators (think of it as of defi plugin) defines two-way data binding rules for common use (HTML binding, attribute binding, etc).',
  npm: 'common-binders',
  tags: ['browser'],
}, {
  ...
  name: 'file-binders',
  githubLink: 'https://github.com/finom/defi/tree/master/packages/file-binders',
  description: 'A set of three binder creators for easy file read and drag\'n\'drop.',
  npm: 'file-binders',
  tags: ['browser'],
}];
