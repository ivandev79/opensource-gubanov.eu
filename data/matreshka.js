...
export default [{
    ...
    name: 'todomvc',
    owner: 'matreshkajs',
    description: <span>Well-documented TodoMVC application written using Matreshka.js. The documentation is generated with <a href="https://jashkenas.github.io/docco/" target="_blank" rel="noopener noreferrer">docco</a></span>,
    tags: ['example'],
}, {
